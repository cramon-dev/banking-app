...
export interface UserAccount {
  ...
  /*
    ...
    Maybe I'm overcomplicating this; maybe the account should just know its own balance as a property, but the transaction manager should be the only one able to modify it.
  */
  balance: number;
